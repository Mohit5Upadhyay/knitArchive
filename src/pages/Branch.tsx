...
//               rounded-xl p-8 transform transition-all duration-300 hover:scale-105 
//               hover:border-[#ff6600] hover:shadow-2xl hover:shadow-[#ff6600]/20">
...
//                   transition-all duration-300">
//                     <svg className="w-6 h-6 text-[#ff6600]" fill="none" 
